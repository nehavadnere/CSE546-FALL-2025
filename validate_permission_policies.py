...
class iam_policies():
    ...
    def validate_lamnda(self, attached_policies):
    ...
    def validate_policies(self):
        ...
        try:
            ...
            lambda_ro_access_flag   = self.validate_lamnda(policy_names)
            return iam_ro_access_flag, sqs_full_access_flag, lambda_ro_access_flag
