...
for index, row in roster_df.iterrows():
    ...
    if zip_files and os.path.isfile(zip_files[0]):
        ...
        face_deduction_path  = "extracted/face-detection/fd_lambda.py"
        ...
        if not cred_values or not fd_code_exist or not fr_code_exist:
            sanity_pass     = False
            test_pass       = False
            test_status     = "Fail"
        ...
        if sanity_pass:
            ...
            try:
                ...
                try:
                    ...
                    iam_ro_access_flag, sqs_full_access_flag, lambda_ro_access_flag = iam_obj.validate_policies()
                    ...
                    aws_grader    = grader_project2(logger, asuid, cred_values[0], cred_values[1], sqs_full_access_flag, lambda_ro_access_flag)
                    fd_lambda_url = cred_values[2]
                    sqs_resp_url  = cred_values[3]

                    test_results  = aws_grader.main(num_requests, fd_lambda_url, sqs_resp_url, img_folder, pred_file)
